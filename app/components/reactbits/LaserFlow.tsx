...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    // Remede o canvas algumas vezes após o layout assentar (corrige o bug em
    // que o tamanho fica errado no load e só conserta ao redimensionar a janela).
    const settleTimers = [50, 150, 320, 600, 1000, 1800, 3000].map(ms => window.setTimeout(scheduleResize, ms));
...
export default LaserFlow as any;
